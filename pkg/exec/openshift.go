...
func (deh *OpenShiftExecHandler) ExecInContainer(client dockertools.DockerInterface, container *docker.Container, cmd []string, stdin io.Reader, stdout, stderr io.WriteCloser, tty bool) error {
