			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"dockerShimSocket": {
							SchemaProps: spec.SchemaProps{
								Description: "dockerShimSocket is the path to the dockershim socket.",
								Type:        []string{"string"},
								Format:      "",
							},
						},
